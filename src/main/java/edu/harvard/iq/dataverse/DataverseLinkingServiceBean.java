...
@Stateless
@Named
public class DataverseLinkingServiceBean implements java.io.Serializable, Saver<DataverseLinkingDataverse> {
    ...
    public DataverseLinkingDataverse save(DataverseLinkingDataverse dataverseLinkingDataverse) {
